...
# --- Final Stage (Minimalist runtime basato su Debian Bookworm) ---
...
# ❌ RIMOZIONE: Abbiamo eliminato la riga 'RUN touch /app/wasa.db'.
# Il database verrà creato e inizializzato dal codice Go al primo avvio.
